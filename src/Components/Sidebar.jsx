      ...
      <div className='sidebar tilt-in-top-1'>
        ...
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="fas fa-fw fa-table"></i><span>Components</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="fas fa-fw fa-table"></i><span>Utilities</span></a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="#">
            <i class="fas fa-fw fa-table"></i><AiOutlineLineChart/>&nbsp;<span>Chart</span></a>
        </li>
        <li class="nav-item">
        <a class="nav-link" href="#">
